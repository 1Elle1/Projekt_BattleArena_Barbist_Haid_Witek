...
public class Arena{
	...
	public void printStats(CharackterTyps attacker, CharackterTyps victim) {
		...
		if(attacker.isSpecialAbilityActive()) {
			System.out.println("Deine Spezielf�higkeit ist Aktiv");
		}else {
			System.out.println("Deine Spezielf�higkeit ist nicht Aktiv");
		}
		System.out.println("Dein Gegner hat noch " + victim.getHealthPoints() + " Leben \n");
		System.out.println("Wie m�chtest du fortfahren? Tippe 1,2 oder 3");
